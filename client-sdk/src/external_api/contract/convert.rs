use alloy::primitives::{Address as AlloyAddress, B128, B256, U256 as AlloyU256};
...
pub fn convert_u256_to_intmax(input: AlloyU256) -> IntmaxU256 {
    IntmaxU256::from_bytes_be(&input.to_be_bytes_vec()).unwrap()
}
...
pub fn convert_address_to_intmax(input: AlloyAddress) -> IntmaxAddress {
    IntmaxAddress::from_bytes_be(&input.0 .0).unwrap()
}
...
pub fn convert_b128_to_byte16(input: B128) -> Bytes16 {
    Bytes16::from_bytes_be(&input.0).unwrap()
}

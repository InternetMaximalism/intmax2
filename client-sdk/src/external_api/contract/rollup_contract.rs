...
mod tests {
    ...
    #[tokio::test]
    async fn test_get_rollup_events() {
        env_logger::builder()
        ...
        let deployed_block_number = 8496460;
        ...
        let blocks = rollup_contract
            .get_blocks_posted_event(rollup_contract.deployed_block_number)
            .await
            .unwrap();
        dbg!(&blocks.0[0]);
    }

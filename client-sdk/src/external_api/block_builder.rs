...
use intmax2_interfaces::api::{
    block_builder::{
        interface::{BlockBuilderClientInterface, BlockBuilderStatus, BlockBuilderFeeInfo, FeeProof},
        types::{
...
impl BlockBuilderClientInterface for BlockBuilderClient {
    async fn get_fee_info(&self, block_builder_url: &str) -> Result<BlockBuilderFeeInfo, ServerError> {
        get_request::<(), BlockBuilderFeeInfo>(block_builder_url, "/block-builder/fee-info", None).await
    }
